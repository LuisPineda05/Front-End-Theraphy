...
import {MyTreatmentsComponent} from "./user-type/physiotherapist/pages/my-treatments/my-treatments.component";
import {NewTreatmentComponent} from "./user-type/physiotherapist/pages/new-treatment/new-treatment.component";
...
const routes: Routes = [
  ...
  {path: 'my-treatments', component: MyTreatmentsComponent},
  {path:'new-treatment', component: NewTreatmentComponent}
];
